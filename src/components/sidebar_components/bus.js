  ...
  return (
    <>
      <section className=' ml-[250px] bg-blue-600 py-4 px-5'>
        <p className='text-white text-3xl font-semibold pt-4'>Search for Bus</p>
          ...
          {oneWaySelected && (
            <div className='flex gap-2 mt-6 mb-2'>
              <div className='bg-white md:w-[150px] lg:w-[170px] xl:w-[260px] h-[2.8rem] rounded-md  flex justify-center items-center'>
                <select
                  className='outline-none border-none w-[150px] text-sm bg-transparent p-2.5  ml-2 mr-2.5'
                  name=''
                  id=''
                >
